#!/usr/bin/env python3
"""Documentation repair batch 23c: include/openssl/store.h symbols."""
...
# ----- store.h: context / open / ctrl / load -----
...
int OSSL_STORE_find(OSSL_STORE_CTX *ctx, const OSSL_STORE_SEARCH *search);
""",
    "OSSL_STORE_expect_find",
)

# ----- provider loader fetch API -----
...
# ----- deprecated ENGINE-based loader registration -----
