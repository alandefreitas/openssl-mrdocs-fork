 ...
 */
/**
 * @brief Mutable NUL-terminated C string pointer used with STACK_OF(OPENSSL_STRING) / LHASH.
 */
typedef char *OPENSSL_STRING;
/**
 * @brief Const NUL-terminated C string pointer used with STACK_OF(OPENSSL_CSTRING).
 */
 ...
 */
/**
 * @brief Opaque pointer to a non-NUL-terminated byte block for STACK_OF(OPENSSL_BLOCK) (unused by OpenSSL; deprecated).
 */
