...
/**
 * @brief Load ASN.1 library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
...
/**
 * @brief Load BUF library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
OSSL_DEPRECATEDIN_3_0 int ERR_load_BUF_strings(void);
#ifndef OPENSSL_NO_CMS
/**
 * @brief Load CMS library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
...
/**
 * @brief Load CRYPTO library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
OSSL_DEPRECATEDIN_3_0 int ERR_load_CRYPTO_strings(void);
#ifndef OPENSSL_NO_CT
/**
 * @brief Load Certificate Transparency library error strings (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
...
/**
 * @brief Load ENGINE library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
...
/**
 * @brief Load RAND library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
OSSL_DEPRECATEDIN_3_0 int ERR_load_RAND_strings(void);
/**
 * @brief Load RSA library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
...
/**
 * @brief Load X509V3 library error strings into the error queue (deprecated no-op in OpenSSL 3+).
 * @return 1.
 */
