 ...
 * @param fmt printf-style format for extra data, or NULL for none; remaining arguments match @p fmt when non-NULL.
 */
 ...
 * @param num Number of following NUL-terminated @c char * arguments to concatenate (total length per error capped at 4096 bytes).
 */
 ...
 */
OSSL_DEPRECATEDIN_1_1_0 void ERR_remove_thread_state(void *tid);
#endif
